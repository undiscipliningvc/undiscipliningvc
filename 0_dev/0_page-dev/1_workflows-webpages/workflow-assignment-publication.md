...
2. Open assignment checklist in Word, open the "/0_dev/0_page-dev/2_python-files/spreadsheet-assignment-1.csv" file in Visual Studio Code and complete all fields using the checklist except:

a. assignment-overview, cluster-description, and biography, all of which will be provided in a separate Word file and need to be converted into HTML first (see next step) or
